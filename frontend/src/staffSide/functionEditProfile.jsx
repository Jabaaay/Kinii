...
<div className="prof-card1">
  ...
  <div className="prof1">
    ...
    <button onClick={() => handleNavigation('/staff-Profile')}>Account Overview</button>
  ...
  <table className='t2'>
    ...
    <tr>
      <button className='editBtn' onClick={() => handleNavigation('/staff-Profile')}>Save Changes</button>
    </tr>
  </table>
