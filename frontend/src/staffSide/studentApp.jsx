...
function Status() {
    ...
    const fetchAppointments = async () => {
        try {
            const response = await fetch('http://localhost:3001/staff/appointments'); // Your specified endpoint
    ...
    const handleConfirm = async (id) => {
        try {
            const response = await fetch(`http://localhost:3001/staff/confirm/${id}`, { method: 'PUT' });
